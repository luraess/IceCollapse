...
@views function update_stresses!((;Pr,Pr_old,Pr_c,dPr,K,τxx,τyy,τxy,dτxx,dτyy,dτxy,τxyv,τxx_old,τyy_old,τxy_old,dQdτxx,dQdτyy,dQdτxy,Fchk,τII,F,λ,εxx,εyy,εxy,εxyv,εxx_ve,εyy_ve,εxy_ve,εII_ve,η_vep,Vx,Vy,∇V,η,G,dτ_r),τ_y,sinϕ,sinψ,η_reg,relλ,dt,re_mech,vdτ,lτ,r,dx,dy,iter)
